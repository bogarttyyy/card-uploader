...
This project uses Next.js `16.2.2`, which may differ from familiar Next.js behavior. Before changing Next.js APIs, routing, config, or file conventions, read the relevant guide in `node_modules/next/dist/docs/` and follow any deprecation notices.
